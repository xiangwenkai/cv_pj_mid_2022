...
gen_val = DataLoader(val_dataset, shuffle=False, batch_size=4, num_workers=num_workers, pin_memory=True,
                     drop_last=True, collate_fn=frcnn_dataset_collate)
...
# files = ['2010_003331.jpg', '2008_002958.jpg', '006201.jpg', '2009_001501.jpg']
# files = ['005321.jpg', '2010_000926.jpg', '002469.jpg', '2009_001706.jpg']
# files = ['000867.jpg', '2008_002357.jpg', '002145.jpg', '2010_001548.jpg']
# files = ['2009_001602.jpg', '2011_002974.jpg', '2011_001422.jpg', '004957.jpg']
files = ['2008_006880.jpg', '002173.jpg', '007481.jpg', '002118.jpg']
...
for i, file in enumerate(files):
    box_arr = a[i]
    orgimg = np.array(Image.open('VOCdevkit/VOC2007/JPEGImages/{}'.format(file)).convert('RGB'))

    # img_r = cv2.groupRectangles([[0,0,100,100],[8,8,30,30]], 1, 0.1)
    for box in box_arr:
        u = random.random()
        if u>0.5:
            orgimg = cv2.rectangle(img=orgimg, pt1=(box[0], box[1]), pt2=(box[2], box[3]), color=(255,0,0),thickness=1)
    plt.imshow(orgimg)
    plt.savefig('processed_img/{}.png'.format(file.split('.')[0]),dpi=100)
